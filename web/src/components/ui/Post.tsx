...
const Post: React.FC<PostProps> = ({ username, content, timestamp, userAvatarUrl, imgUrl }) => {
  ...
  return (
    <div className='bg-gray-100 dark:bg-gray-800 dark:border-gray-700 border-2 border-gray-300 h-auto px-6 flex flex-col rounded-md gap-2 w-full pt-8 md:w-[70%] xl:w-[50%]'>
