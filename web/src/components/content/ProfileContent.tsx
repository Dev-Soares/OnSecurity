...
import { GearIcon, PencilSimpleIcon } from '@phosphor-icons/react'
    ...
    <main className=' min-h-screen pb-28 md:pb-16 lg:pb-0 lg:py-8 lg:px-8 flex flex-col gap-6 bg-white dark:bg-gray-950'>
      <div className="w-full relative flex flex-col rounded-b-3xl">
        ...
        <div className='bg-none h-30 rounded-t-3xl w-full'>
          <div className='flex flex-col items-start justify-start mt-10 p-4 sm:p-6 pt-12 sm:pt-16 gap-4 sm:gap-6 md:gap-6'>
            <div className='flex flex-col gap-1 w-full'>
              ...
              <h2 className='text-xl lg:text-xl font-medium text-gray-950 dark:text-white ml-1 '>Bernardo Soares</h2>
            </div>
            <div className='flex flex-col gap-1 w-full'>
              ...
              <h2 className='text-xl lg:text-xl font-medium text-gray-950 dark:text-white ml-1 '>15/03/1998</h2>
            </div>
            <div className='flex flex-col gap-1 w-full'>
              ...
              <h2 className='text-xl lg:text-xl font-medium text-gray-950 dark:text-white ml-1 '>bernardo.soares@email.com</h2>
            </div>
            <div className='flex flex-col gap-1 w-full'>
              ...
              <h2 className='text-xl lg:text-xl font-medium text-gray-950 dark:text-white ml-1 '>••••••••••</h2>
            </div>
            <div className='flex gap-3'>
              ...
              <button className='px-3 py-2 md:px-4 md:py-2.5 rounded-lg hover:bg-blue-600 dark:hover:bg-blue-600 hover:scale-105 transition-all duration-500 flex items-center gap-2 bg-gray-100 dark:bg-gray-900 cursor-pointer group'>
                <GearIcon size={20} weight="regular" className='text-blue-600 dark:text-gray-200 group-hover:text-white transition-colors duration-300' />
