        ...
        <div className='bg-none h-30 rounded-t-3xl w-full'>
          <div className='flex flex-col items-start justify-start mt-10 p-4 sm:p-6 pt-12 sm:pt-16 gap-4 sm:gap-5 md:gap-6'>
            <div className='flex flex-col gap-1 w-full'>
              ...
              <h2 className='text-base sm:text-lg md:text-xl lg:text-xl font-medium text-gray-950 dark:text-white ml-1 '>Bernardo Soares</h2>
            </div>
            <div className='flex flex-col gap-1 w-full'>
              ...
              <h2 className='text-base sm:text-lg md:text-xl lg:text-xl font-medium text-gray-950 dark:text-white ml-1 '>15/03/1998</h2>
            </div>
            <div className='flex flex-col gap-1 w-full'>
              ...
              <h2 className='text-base sm:text-lg md:text-xl lg:text-xl font-medium text-gray-950 dark:text-white ml-1 '>bernardo.soares@email.com</h2>
            </div>
            <div className='flex flex-col gap-1 w-full'>
              ...
              <h2 className='text-base sm:text-lg md:text-xl lg:text-xl font-medium text-gray-950 dark:text-white ml-1 '>••••••••••</h2>
            </div>
            <div className='flex gap-3'>
              <button className='px-3 py-2 md:px-4 md:py-2.5 rounded-lg hover:bg-blue-600 dark:hover:bg-blue-600 hover:scale-105 transition-all duration-500 flex items-center gap-2 bg-gray-100 dark:bg-gray-900 cursor-pointer group'>
                <PencilSimple size={20} weight="regular" className='text-blue-600 dark:text-gray-200 group-hover:text-white transition-colors duration-300' />
              ...
              <button className='px-3 py-2 md:px-4 md:py-2.5 rounded-lg hover:bg-blue-600 dark:hover:bg-blue-600 hover:scale-105 transition-all duration-500 flex items-center gap-2 bg-gray-100 dark:bg-gray-900 cursor-pointer group'>
                <Gear size={20} weight="regular" className='text-blue-600 dark:text-gray-200 group-hover:text-white transition-colors duration-300' />
