...
const SignupPage: React.FC = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900">
      <div className='bg-gradient-to-r from-blue-700 to-blue-900 flex flex-col  h-full lg:min-h-screen lg:pb-24'>
        <div className='  lg:h-full w-full p-1 flex flex-col lg:mt-4'>  
          ...
          <div className='flex flex-col lg:justify-center lg:items-center gap-2'>
            ...
            <div className='w-full h-auto text-white hidden lg:flex flex-row items-center justify-center my-3 '>
              <LogoIcon color='light' size={160} />
              <h2 className='font-semibold text-5xl'>OnSecurity</h2>
            </div>
        ...
        <div className=' flex flex-col justify-center items-center z-10 w-full bg-white dark:bg-gray-900 rounded-t-3xl md:rounded-t-4xl lg:rounded-xl pt-4 lg:w-[45%] xl:w-[35%] self-center lg:h-full   '>
          <SignupForm />
        </div>
      </div>
    </div>
